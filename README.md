...
1. ANSI Colors - CodeHS: https://codehs.com/tutorial/andy/ansi-colors  
2. Chat with object-based protocol - Youtube: https://www.youtube.com/watch?v=GdSN7sD1yo0&t=64s  
3. Logging in Python - GeeksforGeeks: https://www.geeksforgeeks.org/python/logging-in-python/  
4. Logging HOWTO - Python Official Documentation: https://docs.python.org/3/howto/logging.html  
5. Python JSON Serialization/Deserialization Made Easy! - YouTube: https://youtu.be/Fu0swCLAJ8E?si=UQAna4JdxsuCrth7  
6. Python Socket Programming - Multiple Clients Chat - YouTube: https://youtu.be/5G_bNVKdECk?si=eAtwE9kL5PAHXpil  
7. Argument Parsing with argparse in Python - YouTube: https://youtu.be/88pl8TuuKz0?si=PMlLsEHI8EAfpEBc  
8. AI Assistance (ChatGPT prompt used for guidance): https://chatgpt.com/share/692c8130-72ec-8013-8a55-edba50dc50f8  
9. socket — Low-level networking interface - Python Official Documentation https://docs.python.org/3.13/library/socket.html  
10. Python Socket Programming Tutorial - YouTube: https://www.youtube.com/watch?v=3QiPPX-KeSc&t=1209s
